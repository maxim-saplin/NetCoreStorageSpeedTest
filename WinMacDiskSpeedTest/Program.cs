...
namespace WinMacDiskSpeedTest
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            WriteLineWordWrap(
"Testing might take a while on systems with much RAM. Modern operating systems use file caching in memory. Which means that with plenty of RAM test data, "+
"generated by this app and written to disk, will stay in memory and read tests will be severely corrupted. For the sake of accurate evaluation of "+
"storage perfromance (and not RAM), test data file will be created of a size close to system RAM. As well this software increases RAM allocation and "+
"executes read tests on the 1st half of the test file. This ensures RAM caching won't kick in and read tests won't be measuring RAM speed instead.\n");
